...
Using Jupyter Notebook [crypto sentiment](https://github.com/joannemannuella/-crypto-sentimental-analysis-NLP/blob/main/crypto_sentiment.ipynb) and run following:
